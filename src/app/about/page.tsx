...
export const metadata: Metadata = {
  ...
  description:
    'Learn about the 4th edition of Africa Aviation Innovation Summit 2025 in Diani, Kenya.',
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Africa's aviation industry is at a critical turning point, where strategic investments
              and innovation can drive transformative growth. The Africa Aviation Innovation Summit
              2025 brings together aviation leaders, policymakers, investors, and professionals to
              explore how innovative investments can fuel the next phase of Africa's aviation
              expansion.
            </p>
          </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                <div className="space-y-2 text-sm">
                  <p className="text-gray-700">
                    <strong>Dates:</strong> November 6-7, 2025
                  </p>
                  <p className="text-gray-700">
                    <strong>Venue:</strong> Diani Reef Beach Resort, Kenya
                  </p>
                  <p className="text-gray-700">
                    <strong>Expected Attendees:</strong> 500+ executives from 20+ countries
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
                  <h4 className="font-bold text-aviationGold text-sm mb-1">
                ...
                <div className="bg-white p-4 rounded-lg border border-gray-200 text-center">
                  ...
                  <p className="text-xs text-gray-600">
                    Multi-sector partnerships and opportunities
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16">
          <div className="bg-gradient-to-r from-aviationGold/10 via-aviationGold/5 to-aviationGold/10 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-700 mb-8 max-w-2xl mx-auto">
              Secure your place among aviation leaders, investors, and innovators shaping the future
              of African aviation. Limited seats available for this exclusive gathering.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
              ...
              <div className="flex gap-3">
                ...
                <a href="/images/agenda.pdf" download target="_blank" rel="noopener noreferrer">
                  <button className="flex items-center space-x-2 bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors">
            ...
            <div className="text-sm text-gray-600">
              ...
              <a
                ...
                className="text-aviationGold hover:text-aviationGold-600 font-medium"
              >
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {organizingPartners.map((partner, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold font-heading text-charcoal-800 mb-2">
                  {partner.name}
                </h3>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-gray-700 max-w-3xl mx-auto">
              The summit attracts key players across industries, fostering cross-sector
            ...
            {industries.map((industry, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-bold text-charcoal-800 mb-2 text-base">{industry.title}</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {objectives.map((objective, index) => (
              <div
                ...
                className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300"
              >
                <h3 className="font-bold text-aviationGold mb-3 text-base">{objective.title}</h3>
