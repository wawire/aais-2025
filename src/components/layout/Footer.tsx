...
const DEFAULT_FOOTER_SECTIONS: readonly FooterSection[] = [
  {
    ...
    links: [
      ...
      { id: 'sponsors', label: 'Sponsors', href: '/register' },
              ...
              <div className="space-y-4 mt-8">
                <div className="flex items-center group">
                  <div className="flex-shrink-0 w-8 h-8 bg-charcoal-800 rounded-lg flex items-center justify-center mr-3 group-hover:bg-aviationGold transition-colors duration-200">
                    <svg
                      className="w-4 h-4 text-softGray-400 group-hover:text-white"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      aria-hidden="true"
                    >
                ...
                <div className="flex items-start group">
                  ...
                  <div className="text-softGray-300 text-sm font-medium">
                    ...
                    <div className="text-softGray-400">
            ...
            {sections.map(section => (
              <div key={section.id} className="lg:col-span-1">
                ...
                <nav className="space-y-3">
                  {section.links.map(
                    (
                      link // Removed explicit type annotation here as it's now inferred
                    ) => (
                      <div key={link.id}>
                        <Link
                          href={link.href}
                        ...
                        >
                          <span className="flex items-center">
                            ...
                            {link.external && (
                              <svg
                                className="inline w-3 h-3 ml-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                                aria-hidden="true"
                              >
          ...
          <div className="w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0">
              ...
              <div className="flex items-center space-x-6">
                <span className="text-softGray-400 text-sm font-semibold">Follow Us:</span>
