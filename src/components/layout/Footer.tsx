...
/**
 * Professional enterprise footer component for AAIS 2025
 * Previous version with gold top border added
 */
      ...
      <div className="w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-softGray-300 text-body-md leading-relaxed mb-6">
            ...
            {/* Contact Information */}
            <div className="space-y-3 text-body-sm text-softGray-400">
              <div className="flex items-center">
                ...
                <Link
                  ...
                  className="hover:text-aviationGold transition-colors duration-200"
                >
                  {contactInfo.email}
                </Link>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div>{contactInfo.address.city}, {contactInfo.address.country}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          {sections.map((section) => (
            <div key={section.id} className="lg:col-span-1">
              <h3 className="text-white font-semibold text-body-lg mb-4">
                {section.title}
              </h3>
              <nav className="space-y-3">
                {section.links.map((link) => (
                  <div key={link.id}>
                    <Link
                      href={link.href}
                      className="block text-softGray-300 hover:text-aviationGold transition-colors duration-200 text-body-sm"
      ...
      <div className="border-t border-charcoal-800">
        <div className="w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0">
            ...
            {/* Copyright */}
            <div className="text-softGray-400 text-body-sm">
              © {copyrightYear} Africa Aviation Innovation Summit. All rights reserved.
            </div>

            {/* Social Media Links */}
            <div className="flex items-center space-x-6">
              <span className="text-softGray-400 text-body-sm font-medium">
                Follow Us:
              </span>
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <Link
                    ...
                    className="
                      p-2 rounded-lg
                      text-softGray-400 hover:text-aviationGold hover:bg-charcoal-800
            ...
            <div className="flex flex-wrap items-center space-x-6 text-body-sm">
              <Link
                href="/privacy"
                className="text-softGray-400 hover:text-aviationGold transition-colors duration-200"
              >
                Privacy Policy
              </Link>
              <Link
